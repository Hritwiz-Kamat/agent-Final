...
[Website](https://agentbrowser.dev) · [Docs](https://docs.agentbrowser.dev) · [Cloud API](https://agentbrowser.dev/cloud) · [Discord](https://discord.gg/agentbrowser)
...
Your AI Agent
 ...
 AgentBrowser
      ...
      ├── Maps actions (buttons, forms → callable tools)
      ├── Compresses tokens (up to 85% reduction)
...
```
agentbrowser/
├── agentbridge-server/     # MCP Server + REST API (TypeScript)
│   ├── src/
│   │   ├── browser/        # Lightpanda + Chromium adapters
│   │   ├── engine/         # Extraction + compression pipeline
...
Built by [Krish Gupta](https://github.com/krishgupta69) & Ms. Jain
