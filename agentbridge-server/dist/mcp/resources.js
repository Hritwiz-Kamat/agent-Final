 ...
 */
export function cacheExtraction(url, result) {
...
export function registerResources(server) {
    ...
    server.registerResource('page_content', new ResourceTemplate('page://{domain}/{+path}', { list: undefined }), {
        description: 'Structured page content extracted by AgentBridge. ' +
    ...
    server.registerResource('page_text', new ResourceTemplate('page://{domain}/{+path}/text', { list: undefined }), {
        description: 'Clean plain-text content from a webpage, formatted as markdown. ' +
