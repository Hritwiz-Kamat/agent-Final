...
export function registerTools(server) {
    ...
    server.registerTool('extract_page', {
        title: 'Extract Page',
        description: 'Extract structured content and interactive elements from a webpage. ' +
    ...
    server.registerTool('list_actions', {
        ...
        description: 'Get all interactive elements from a webpage as callable tools. ' +
        ...
        try {
            ...
            return {
                content: [{ type: 'text', text: `Action listing failed: ${message}` }],
                isError: true,
            };
        }
    });
    ...
    server.registerTool('get_page_text', {
        title: 'Get Page Text',
        description: 'Get clean text-only content from a webpage, formatted as markdown. ' +
        ...
        try {
            ...
            return {
                content: [{ type: 'text', text: `Text extraction failed: ${message}` }],
                isError: true,
            };
        }
    });
    ...
    server.registerTool('execute_action', {
        ...
        description: 'Execute an action on a webpage element — click a button, fill an input field, ' +
        ...
        try {
            ...
            return {
                content: [{ type: 'text', text: `Action execution failed: ${message}` }],
                isError: true,
            };
        }
    });
